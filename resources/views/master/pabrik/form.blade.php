<div class="modal fade" id="addDataPabrik">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gradient-info pl-3 pr-3 pt-2 pb-2">
                <h6 class="modal-title text-bold m-0">Form Tambah Data Pabrik</h6>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row mb-1">
                            <label for="kode" class="col-sm-4 col-form-label text-sm pr-0">Kode Pabrik <span class="float-sm-right">:</span></label>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5">
                                <input type="text" class="form-control form-control-sm" id="kode" name="kode" placeholder="Auto" tabindex="0" readonly>
                            </div>
                        </div>
                        <div class="form-group row mb-1">
                            <label for="nama" class="col-sm-4 col-form-label text-sm pr-0">Nama Pabrik <span class="float-sm-right">:</span></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="nama" name="nama" placeholder="Nama Pabrik" tabindex="0">
                            </div>
                        </div>
                        <div class="form-group row mb-1">
            ...
            <div class="modal-footer pl-3 pr-3 pt-2 pb-2">
                <button class="btn btn-default btn-md text-bold mr-1" type="reset" id="resetPabrik"><i class="fas fa-retweet text-primary mr-2"></i>Reset</button>
                <button class="btn btn-default btn-md text-bold mr-1" type="submit" id="savePabrik"><i class="fas fa-save text-success mr-2"></i>Simpan Data</button>
            </div>
            </form>
        </div>
    </div>
